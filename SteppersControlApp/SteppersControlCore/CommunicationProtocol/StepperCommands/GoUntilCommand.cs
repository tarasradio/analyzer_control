...
{
    public class GoUntilCommand : AbstractCommand, ICommand
    {
        private byte _stepper;
        private Protocol.Direction _direction;
        private uint _speed;

        public GoUntilCommand(int stepper, Protocol.Direction direction, uint speed, uint packetId) : base(packetId, Protocol.CommandType.WAITING_COMMAND)
        {
